...
from service.word_tokenizer import WordAnalyzer
import bot_base
...
class BotFlooding:
    ...
    def retweet_from_list(cls, list_id: int, place_words:str=None, state_words:str=None, force: bool=False) -> None:
        ...
        analyzer = WordAnalyzer(WordAnalyzer.TRAFFIC_CHAR_FILTER, WordAnalyzer.TRAFFIC_USER_DIC)
        ...
        #     places = [t.base_form for t in tokens if re.search(place_words, t[0])]
        #     states = [t.base_form for t in tokens if re.search(state_words, t[0])]
...
if __name__=="__main__":
    BotFlooding.retweet_from_list(Environ.list_id, place_words=Environ.place_words, state_words=Environ.state_words, force=Environ.force_update)
